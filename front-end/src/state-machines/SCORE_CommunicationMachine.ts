...
const SCORE_CommunicationContext = {
};


export const SCORE_CommunicationMachine = Machine({
  id: 'SCORE_CommunicationMachine',
  initial: 'displayed',
  context: {
    ...SCORE_CommunicationContext
  },
  states: {
    displayed: {
      on: {
        ChangeDefinedPreferences: {
          actions: ['returnTo_PREF']
          // actions: sendParent({ type: 'ReturnToGet_PREF' }),
        },
      },
    },
  },
  ...
  actions: {
    returnTo_PREF: sendParent({ type: 'ReturnToGet_PREF' }),
  }
});
